                    ...
                    <div className="border border-info rounded">
                        <form className="padding-10" onSubmit={this.props.searchHotel}>
                            ...
                            <div className="form-group font-weight-light">
                                ...
                                <input name="start_date" value={this.props.state.start_date} placeholder="Start date"
                            ...
                            <div className="form-group font-weight-light">
                                ...
                                <input name="end_date"
                                       value={moment(this.props.state.end_date) <= moment(this.props.state.start_date) ? "" : this.props.state.end_date}
                                ...
                                <div className="form-group font-weight-light">
                                    ...
                                    <div className="d-flex padding-left-5">
                                        <input name="start_range" defaultValue={this.props.state.start_range}
                                               placeholder="Min"
                                               className="text-center form-control form-control-sm input-width-filter padding-left-10"
                                               type="number"
                                               onChange={this.props.onChange}/>
